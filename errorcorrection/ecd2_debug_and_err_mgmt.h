 ...
 * code. The ecd2_debug_and_err_mgmt section modularizes the parts of the code that is predominantly
 * used for debugging purposes as well as managing errors.
 * 
 */

#ifndef ECD2_DEBUG_ERR_MGMT_H
#define ECD2_DEBUG_ERR_MGMT_H
