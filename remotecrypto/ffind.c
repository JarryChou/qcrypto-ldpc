...
file format input : multiple plain decimal time in 1/8 nsec (whitespace /
newline delimited) */
...
int main(int argc, char *argv[]) {
  ...
  strncpy(fname1, argv[1], FNAMBUFFERLEN);
  fname1[FNAMBUFFERLEN] = 0;
  strncpy(fname2, argv[2], FNAMBUFFERLEN);
  fname2[FNAMBUFFERLEN] = 0;
